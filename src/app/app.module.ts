...
import {AddBlogDialogComponent} from './admin/overview/add-blog-dialog/add-blog-dialog.component';
...
@NgModule({
  ...
  entryComponents: [AddTechnologyDialogComponent, ChangeLoginComponent, AddBlogDialogComponent, OverviewComponent, EditBlogDialogComponent],
